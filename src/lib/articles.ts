...
const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Alcuni segnali da osservare: passare molto tempo a pensare senza arrivare a una decisione, sentirsi mentalmente esausti anche senza aver fatto nulla di fisicamente faticoso, difficolt\u00e0 ad addormentarsi perch\u00e9 la mente non si ferma, e la tendenza a cercare rassicurazioni continue dagli altri.',
